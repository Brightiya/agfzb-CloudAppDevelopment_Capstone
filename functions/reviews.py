...
cloudant_username = "dd5dab06-83d7-4e3f-bdd3-fba01337ae7c-bluemix"
cloudant_api_key = "E2SRo-xKOn_MHYPXHVWiP6ckeM-IZsrGdK-CGiRcX8II"
cloudant_url = "https://dd5dab06-83d7-4e3f-bdd3-fba01337ae7c-bluemix.cloudantnosqldb.appdomain.cloud"
client = Cloudant.iam(
...
def post_review():
    ...
    for field in required_fields:
        if field not in review_data:
            print(f"The '{field}' field is required")
            return (
